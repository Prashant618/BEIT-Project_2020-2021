...
/**
 * Servlet implementation class busForgotpassward
 */
@WebServlet("/busForgotpassward")
public class busForgotpassward extends HttpServlet {
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries(String username, String passward, String cpassward) {
	     //connection = con;
	        ...
	        String sql="select * from busregistertable where busplateno='"+username+"'";
	    	...
	    	try {
	    		...
	    		// ps1.setString(1, "1" );
	             ...
	             if(rs.next()) { 
	            	   ...
	            	   String query="UPDATE busregistertable SET passward='"+passward+"' WHERE busplateno='"+username+"'";
	            		System.out.println();
