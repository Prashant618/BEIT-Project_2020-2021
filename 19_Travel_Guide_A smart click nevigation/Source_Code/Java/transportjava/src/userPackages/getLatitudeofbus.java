...
/**
 * Servlet implementation class getLatitudeofbus
 */
@WebServlet("/getLatitudeofbus")
public class getLatitudeofbus extends HttpServlet {
	...
	public  ArrayList<Book> getAllCountries( String username ) {
	     //connection = con;
	        ...
	        String sql = "select * from locationupdater where name='"+username+"'";
	    	...
	    	try {
		    	...
		    	book.setLatitude(rs.getString("latitude"));
