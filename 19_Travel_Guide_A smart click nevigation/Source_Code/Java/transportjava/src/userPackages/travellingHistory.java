...
/**
 * Servlet implementation class travellingHistory
 */
@WebServlet("/travellingHistory")
public class travellingHistory extends HttpServlet {
	...
	public  ArrayList<Book> getAllCountries( String username ) {
	     //connection = con;
	        ...
	        String sql = "select * from bookbuspayment where username='"+username+"'";
